...
<article <?php post_class('box content'); ?> id="post-<?php the_ID(); ?>">
    <h3 class="title is-3">
    	<a class="title-link" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a>
    </h3>
    <?php if (!is_page()) { ?>
		<h5 class="subtitle is-5">Posted by <?php the_author_posts_link(); ?> on <?php echo get_the_date(); ?></h5>
    <?php } ?>
